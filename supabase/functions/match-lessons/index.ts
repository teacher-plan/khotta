...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const system = [
      ...
      "عناوين الدروس الرئيسية في النصّ مسبوقة غالباً بالعلامة «§§» (وُضعت لأنها ظهرت أعلى يمين الصفحة بخطّ كبير). اعتمد على هذه العلامات أولاً لتحديد بداية كل درس.",
      "لكل درس في القائمة (بالترتيب)، جد الموضع الذي يبدأ فيه ذلك الدرس في النصّ (ويُفضّل أن يكون عند علامة §§ الأقرب لمعناه)، وانسخ حرفياً أول 6 إلى 10 كلمات متتالية من ذلك الموضع كما وردت في النصّ تماماً (لا تعدّلها ولا تترجمها، وبلا العلامة §§).",
