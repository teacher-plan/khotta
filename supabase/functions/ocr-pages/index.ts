...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const system = [
      ...
      "مهم: عنوان الدرس يظهر عادةً في أعلى يمين الصفحة بخطّ كبير بارز. إذا رأيت عنوان درس بهذه المواصفات، فابدأ سطراً جديداً وضع قبله العلامة «§§ » ثم العنوان، لتمييزه عن بقية النصّ. لا تضع العلامة إلا لعناوين الدروس الرئيسية الكبيرة، لا للعناوين الفرعية أو الفقرات.",
