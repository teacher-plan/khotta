...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const system = [
      ...
      "مهم جداً — تعليم عناوين الدروس: عنوان الدرس يظهر في أعلى الصفحة بخطّ كبير بارز ويليه محتوى الدرس. ضع قبل كل عنوان درس فعلي العلامة «§§ » في سطر مستقل ثم العنوان.",
      "علّم كل عنوان درس حقيقي بلا استثناء (لا تنسَ أياً منها)، لكن لا تعلّم: العناوين الفرعية داخل الدرس، ولا عناوين صفحة الفهرس/المحتويات (التي تسرد أسماء دروس متجاورة بلا محتوى بينها)، ولا ترويسة/تذييل الصفحة المتكرّرة.",
      "القاعدة الحاسمة: ضع §§ فقط للعنوان الكبير الذي **يبدأ فوقه درس جديد بمحتوى فعلي تحته**.",
