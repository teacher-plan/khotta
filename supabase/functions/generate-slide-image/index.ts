...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const style = st.slide_style_prompt || [
      ...
      "النص قليل ومدمج داخل المخطط: تسميات قصيرة بجانب العناصر، وصناديق صغيرة مستديرة للملاحظات المهمة، والأرقام والقواعد بارزة بخط أعرض.",
      "الأرقام بالأرقام العربية المشرقية (١٢٣) ورموز الوحدات العالمية كما هي (kg, mL)، وأي معادلة أو عملية حسابية مكتوبة من اليمين إلى اليسار متوافقة مع اتجاه النص العربي.",
