...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // نظام بصري موحّد: أكاديمي صارم — المحتوى فقط، والرسم الوحيد المسموح هو ما يشرح المفهوم
    const style = st.slide_style_prompt || [
      "شريحة عرض تعليمية عريضة (16:9) بتصميم أكاديمي نظيف صارم البساطة.",
      "التكوين: خلفية بلون واحد فاتح هادئ تماماً (أبيض مائل للدفء أو رمادي فاتح جداً)، شريط رفيع واحد بلون مميز أعلى الشريحة أو بجانب العنوان، عنوان كبير غامق، ثم النقاط نصاً منظماً بتباعد مريح. هذا كل شيء.",
      "ممنوع منعاً باتاً: الشخصيات الكرتونية، الوجوه، الرموز التعبيرية، الأيقونات الزخرفية، النجوم، الدوائر والفقاعات الملونة، الخلفيات المقسمة لمناطق ملونة، أي عنصر بصري لا يشرح المحتوى مباشرة.",
      "استثناء وحيد: إن كانت نقطة تحتاج توضيحاً بصرياً لفهمها (كسر يحتاج شكلاً مقسماً، مقارنة تحتاج جدولاً، تسلسل يحتاج مخططاً بسيطاً) — ارسم ذلك التوضيح وحده بأسلوب تخطيطي مسطح بسيط، في مساحة محددة بجانب النقطة.",
      "إبراز الأرقام والقواعد المهمة بلون واحد بارز (أزرق داكن أو أخضر عميق) — الإبراز بالخط واللون، لا بالرسوم.",
      "ترقيم الشريحة رقماً صغيراً في الزاوية السفلية.",
