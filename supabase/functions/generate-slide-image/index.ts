...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // نظام بصري موحّد: المحتوى الثمين أولاً — رسومات توضيحية فقط حين تشرح المفهوم
    const style = st.slide_style_prompt || [
      "أسلوب بصري موحّد: شريحة عرض تقديمي تعليمية عريضة (16:9) نظيفة واحترافية بألوان جميلة متناسقة.",
      "الأولوية المطلقة للمحتوى التعليمي: نص واضح منظم يحقق أهداف الدرس — لا حشو ولا زخارف زائدة إطلاقاً.",
      "الرسومات مسموحة فقط إذا كانت توضيحية تشرح المفهوم نفسه (شكل هندسي مقسم للكسور، مخطط، خط أعداد، تمثيل بياني) — ممنوع أي رسمة للزينة أو شخصيات لا علاقة لها.",
      "خلفية فاتحة هادئة، عنوان كبير بلون مميز، نقاط منظمة بتباعد مريح، وإبراز الأرقام والقواعد المهمة بلون بارز.",
      "ترقيم الشريحة صغير في زاوية سفلية.",
