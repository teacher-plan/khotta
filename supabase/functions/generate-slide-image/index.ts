...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const style = st.slide_style_prompt || [
      "شريحة عرض تعليمية عريضة (16:9): كل شريحة عبارة عن مخطط توضيحي واحد كبير يملأ الشريحة — الرسم نفسه هو الشرح، وليس نصاً مع زخرفة.",
      "الخلفية: لون فاتح دافئ موحّد (أبيض مائل للكريمي). العنوان بخط عربي عريض غامق أعلى الشريحة.",
      "حوّل محتوى النقاط إلى تمثيل بصري تخطيطي يناسب معناها: مقارنة بين مفهومين → انقسام الشريحة نصفين بلونين متمايزين؛ تدرّج أو مستويات → درج ثلاثي الأبعاد بسيط؛ تحويل أو عملية → أسهم انسيابية كبيرة تحمل الرقم/العملية؛ تصنيف أو قرار → خريطة تدفق بمربعات مستديرة الزوايا وأسهم؛ تعريف مفرد → بطاقة كبيرة برسمة واحدة معبرة.",
      "أسلوب الرسم: مسطح بخطوط خارجية رفيعة داكنة (hand-drawn flat)، أشياء واقعية مألوفة للطالب (ميزان، دورق، أكياس، ملعقة، مواد من بيئته) — بلا وجوه ولا شخصيات كرتونية ولا رموز تعبيرية.",
      "نظام لوني دلالي ثابت في العرض كله: لونان رئيسيان هادئان متمايزان (مثل برتقالي طيني ↔ أزرق مخضر) يرمز كل منهما لمفهوم/فرع ويثبت عليه في كل الشرائح، مع لمسات محايدة.",
      // قيدٌ صارم على النص المكتوب: التجربة أظهرت أن النموذج حين يُترك يخترع
      // تسميات من عنده يُخطئ إملائياً («يمشأ» بدل «يملأ») ويُكرّر العبارة
      // مرتين في الشريحة. حصرُ المكتوب في العنوان والنقاط المُملاة يقلّص
      // مساحة الخطأ إلى نصٍّ راجعَه نموذجٌ نصّيٌّ سلفاً.
      "النص المكتوب في الصورة محصورٌ حصراً في: العنوان والنقاط المذكورة أدناه حرفياً، وتسميةٍ واحدةٍ قصيرة (كلمة أو كلمتان) لكل عنصرٍ مرسوم عند اللزوم. لا تُضِف جملاً ولا شروحاً ولا صناديق ملاحظات من عندك.",
      "لا تُكرّر أي عبارة أو تسمية مرتين في الشريحة الواحدة — كل نصٍّ يظهر مرة واحدة فقط في موضعه.",
      "إن لم تكن واثقاً من إملاء كلمةٍ عربية فاحذفها ولا تكتبها: رسمٌ صامتٌ خيرٌ من كلمةٍ مغلوطة أمام الطلاب.",
      "كل رقمٍ يُكتب بالأرقام العربية المشرقية (٠١٢٣٤٥٦٧٨٩) بلا استثناء — حتى الملتصق بوحدة قياس: «٥٠ mL» لا «50 mL»، و«٢ kg» لا «2 kg». رموز الوحدات وحدها تبقى لاتينية. تجنّب كتابة الأرقام أصلاً ما لم تكن جزءاً من المحتوى المُملى.",
      "أي معادلة أو عملية حسابية مكتوبة من اليمين إلى اليسار متوافقة مع اتجاه النص العربي.",
      "النص العربي يجب أن يكون دقيقاً إملائياً ومقروءاً تماماً — أهم شرط على الإطلاق.",
      "لا صور فوتوغرافية، لا حشو زخرفي، ولا نص غير المطلوب حرفياً أدناه.",
    ].join(" ");
    ...
    const kindPrompt = kind === "cover"
      ...
      : kind === "closing"
        ...
        : "هذه شريحة محتوى: العنوان أعلى الشريحة، وحوّل النقاط كلها إلى مخطط توضيحي واحد متكامل يجسّد معناها (لا تكتبها قائمة نقاط مجردة — ادمجها كتسميات وعناصر داخل المخطط).";
