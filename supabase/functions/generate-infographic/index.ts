...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const userPrompt = [
      ...
      bookContext
        ? `نص الدرس من كتاب الطالب المعتمد (مرجعٌ لاستخراج الأفكار الرئيسية فقط — ليس نصاً يُنسخ حرفياً ولا ترتيباً يُتَّبَع):\n${bookContext}`
        : bookImages.length
      ...
      "لخّص نص الدرس لاستخراج أفكاره الرئيسية فقط، ثم ابنِ من هذه الأفكار محتوى الإنفوجرافيك بترتيبٍ منطقيٍّ يخدم فهم الطالب — لا بالضرورة نفس ترتيب أو تسلسل الكتاب.",
      ...
      "رتّب أهم المفاهيم والقواعد في أقسامٍ واضحة مرقّمة (أولاً، ثانياً، ثالثاً...) مع تمثيل بصري مرسوم لكل مفهوم.",
