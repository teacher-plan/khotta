...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const system = [
      ...
      "الأرقام في كل الحقول (لا narration وحده) بالترقيم العربي-الهندي (٠١٢٣٤٥٦٧٨٩) لا اللاتيني، وأي معادلة أو عملية حسابية تُكتب من اليمين إلى اليسار متوافقة مع اتجاه النص العربي.",
